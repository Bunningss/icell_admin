...
export const familyColumns = [
  {
    ...
    width: 230,
    renderCell: (params) => {
      return <div className="cellWithImg">{params.row.HeadName}</div>;
    },
  },
  {
    field: "MahalId",
...
export const mahalColumns = [
  {
    ...
    width: 230,
    renderCell: (params) => {
      return <div className="cellWithImg">{params.row.MahalId}</div>;
    },
  },
  {
    field: "MahalluName",
    ...
    width: 230,
    renderCell: (params) => {
      return <div className="cell">{params.row.MahalluName}</div>;
    },
  },
];
...
export const userColumns = [
  ...
  },
  {
    ...
    width: 230,
    renderCell: (params) => {
      return <div className="cell">{params.row.Email}</div>;
    },
  },
  {
    field: "MahalId",
  ...
  },
  {
    ...
    width: 230,
    renderCell: (params) => {
      return <div className="cellWithImg">{params.row.TypeOfUser}</div>;
    },
  },
];
    ...
    renderCell: (params) => {
      return (
        <div className="cellAction">
          <Link
            to={`/families/${params.row.FamilyId}`}
...
export const mahalAction = [
  {
    ...
    renderCell: (params) => {
      ...
      return (
        <div className="cellAction">
          <Link
            to={`/mahal/details/${params.row.MahalId}`}
            style={{ textDecoration: "none" }}
          >
            <div className="viewButton">View</div>
          </Link>
          ...
          <div className="confirmation">
            <div className="content">
              ...
              <div className="btn-wrapper">
                <button className="viewButton" onClick={handleAction}>
                  No
                </button>
...
export const reportAction = [
  {
    ...
    renderCell: (params) => {
      return (
        <div className="cellAction">
          <Link
            to={`/mahalreport/${params.row.MahalId}`}
            style={{ textDecoration: "none" }}
          >
